...
import { Plus, Minus, Save, ArrowLeft, Search, X } from 'lucide-react';
...
const CreateTest: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      error(err.response?.data?.message || 'Failed to create test');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-gray-600">Build a new test from your question library</p>
        </div>
      </div>
